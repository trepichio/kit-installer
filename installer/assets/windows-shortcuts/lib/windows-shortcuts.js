...
function commandArgs(type, path, options) {
	console.log(`TCL: commandArgs -> path ${path}`)
...
exports.query = function (path, callback) {
	execFile(process.cwd() + '/Shortcut.exe',
...
exports.create = function (path, optionsOrCallbackOrTarget, callback) {
	console.log(`TCL: exports.create -> path ${path}`)
	...
	console.log(`TCL: exports.create.dirName -> dirName ${process.cwd()}`)
	console.log(execFile(process.cwd() + '\\Shortcut.exe',
...
exports.edit = function (path, options, callback) {
	console.log(`TCL: exports.edit -> path ${path}`)
	execFile(process.cwd() + '/Shortcut.exe',
